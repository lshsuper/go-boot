...
var file_example_proto_rawDesc = []byte{
	...
	,
...
var file_example_proto_goTypes = []interface{}{
	(*SayReq)(nil), // 0: pb.SayReq
	(*SayRes)(nil), // 1: pb.SayRes
}
var file_example_proto_depIdxs = []int32{
	0, // 0: pb.Example.Say:input_type -> pb.SayReq
	1, // 1: pb.Example.Say:output_type -> pb.SayRes
...
func (c *exampleClient) Say(ctx context.Context, in *SayReq, opts ...grpc.CallOption) (*SayRes, error) {
	out := new(SayRes)
	err := c.cc.Invoke(ctx, "/pb.Example/Say", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedExampleServer) Say(context.Context, *SayReq) (*SayRes, error) {
...
func _Example_Say_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ExampleServer).Say(ctx, req.(*SayReq))
	}
